...
## Corpus Check
- 30 files · ~9,872 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 277 nodes · 407 edges · 19 communities (17 shown, 2 thin omitted)
...
8. `belgium_kopyala()` - 9 edges
9. `gtsrb_kopyala()` - 8 edges
10. `main()` - 8 edges
...
- `connect_carla()` --calls--> `apply_world_settings()`  [EXTRACTED]
  connect_carla.py → scenarios/load_map.py
...
### Community 0 - "main.py"
Cohesion: 0.11
Nodes (20): get_datas(), Vehicle, World, connect_carla(), clamp(), LaneFollowController, Basit şerit takip kontrolcüsü.      Görevleri:     1. İlerideki waypoint'e gö, get_vehicle_data() (+12 more)
